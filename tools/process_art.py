...
EXTRA_SIZE = {
    ...
    "ui_panel_light": 256,
    "ui_panel_card": 256,
    # 按钮九宫格胶囊：源图是方形画布、胶囊只占中间一条，其余是透明留白；
    # 若按 ui 默认 96×96 方形输出，九宫格(SLICED)渲染时透明留白参与切片，
    # 按钮会被压成一条细线（2026-08-24 首修，2026-09-11 重跑全量复发后补此特例）。
    # 走 process_fit：先按透明 bbox 裁出胶囊 → 等比缩放 → 居中放入目标画布
    "ui_btn_green": (96, 42),
    "ui_btn_blue": (96, 48),
    # 特效光效类稍大
    "fx_glow": 128,
